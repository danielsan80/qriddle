...
The parchment behind it is not a photograph: it is generated by
`tools/generate-parchment.py`, one noise field at a time.
[doc/parchment](doc/parchment) takes that script apart layer by layer.

[doc/prototype](doc/prototype) keeps the single HTML file this all started as,
next to a note on what the algorithm got right and what it got wrong.
